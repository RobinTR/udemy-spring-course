...
import com.robn.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course course1 = new Course("Backend Development");
		Course course2 = new Course("Full-Stack Development");
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		Student student1 = new Student("John", "Doe", "john@ho.com");
		Student student2 = new Student("John2", "Doe2", "john2@ho.com");
